            ...
            <?php if (!empty($posts)): ?>
                <?php foreach ($posts as $p): ?>
                    <article class="post-article" data-tags="<?php echo htmlspecialchars(json_encode($p['tags_array']), ENT_QUOTES, 'UTF-8'); ?>" style="<?php echo in_array($default_tag, $p['tags_array']) ? '' : 'display: none;' ?>">
                        ...
                        <?php if (!empty($p['download_path'])): ?>
                            <div style="margin-bottom: 1rem;">
                                <a href="<?php echo htmlspecialchars($p['download_path'], ENT_QUOTES, 'UTF-8'); ?>" download role="button" class="outline" style="font-size: 0.9rem; padding: 0.4rem 0.8rem; border-radius: 6px; display: inline-flex; align-items: center; gap: 0.4rem; text-decoration: none;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                        <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                                    </svg>
                                    <?php echo htmlspecialchars($p['download_name'], ENT_QUOTES, 'UTF-8'); ?>
                                </a>
                            </div>
                        <?php endif; ?>
